"""
[GBB, downloaded from http://code.google.com/p/astrolibpy/]
...
def test_myfunctlin(p, fjac=None, x=None, y=None, err=None):
    # Parameter values are passed in "p"
    # If fjac==None then partial derivatives should not be
    # computed.  It will always be None if MPFIT is called with default
    # flag.
...
def test_linfit():
    ...
    yfit = mpfit.test_Flin(x, m.params)
    plt.plot(x, yfit, color='red', alpha=0.1)
